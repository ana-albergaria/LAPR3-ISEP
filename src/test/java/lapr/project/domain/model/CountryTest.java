...
class CountryTest {
    ...
    public void setUp() {
        ...
        capital2 = new Capital("Valletta");
        capital3 = new Capital("Athens");
        capital4 = new Capital("Lisbon");

        country1 = new Country(continent2,alpha2Codes[0],alpha3Codes[0],names[0],population[0],capital1,lats[0],lons[0]);
        country2 = new Country(continent2,alpha2Codes[1],alpha3Codes[1],names[1],population[1],capital1,lats[1],lons[1]);
        country3 = new Country(continent2,alpha2Codes[2],alpha3Codes[2],names[2],population[2],capital1,lats[2],lons[2]);
        country4 = new Country(continent2,alpha2Codes[3],alpha3Codes[3],names[3],population[3],capital1,lats[3],lons[3]);
    }
    ...
    public void ensureNullContinentNameNotAllowed(){
        IllegalArgumentException thrown = assertThrows(IllegalArgumentException.class, () -> new Country(null,alpha2Codes[0],alpha3Codes[0],names[0],population[0],capital1,lats[0],lons[0]));
    ...
    public void ensureNullAlpha2CodeNotAllowed() {
        IllegalArgumentException thrown = assertThrows(IllegalArgumentException.class, () -> new Country(continent2,null,alpha3Codes[0],names[0],population[0],capital1,lats[0],lons[0]));
    ...
    public void ensureNullAlpha3CodeNotAllowed() {
        IllegalArgumentException thrown = assertThrows(IllegalArgumentException.class, () -> new Country(continent2,alpha2Codes[0],null,names[0],population[0],capital1,lats[0],lons[0]));
    ...
    public void ensureNullNameNotAllowed() {
        IllegalArgumentException thrown = assertThrows(IllegalArgumentException.class, () -> new Country(continent2,alpha2Codes[0],alpha3Codes[0],null,population[0],capital1,lats[0],lons[0]));
    ...
    public void ensurePopulationBelowZeroNotAllowed() {
        IllegalArgumentException thrown = assertThrows(IllegalArgumentException.class, () -> new Country(continent2,alpha2Codes[0],alpha3Codes[0],names[0],-2,capital1,lats[0],lons[0]));
    ...
    public void ensureNullCapitalNotAllowed() {
        IllegalArgumentException thrown = assertThrows(IllegalArgumentException.class, () -> new Country(continent2,alpha2Codes[0],alpha3Codes[0],names[0],population[0],null,lats[0],lons[0]));
    ...
    public void createCountryWithLatitudeUnderMinus90() {
        IllegalArgumentException thrown = assertThrows(IllegalArgumentException.class, () -> new Country(continent2,alpha2Codes[0],alpha3Codes[0],names[0],population[0],capital1,-100,lons[0]));
    ...
    public void createCountryWithLatitudeOver91() {
        IllegalArgumentException thrown = assertThrows(IllegalArgumentException.class, () -> new Country(continent2,alpha2Codes[0],alpha3Codes[0],names[0],population[0],capital1,93,lons[0]));
        assertEquals("Latitude must be between -90 and 90. It might also be 91 in case of being unavailable.", thrown.getMessage());
    }
    ...
    public void checkCreateCountryWithLatitude90() {
        new Country(continent2,alpha2Codes[0],alpha3Codes[0],names[0],population[0],capital1,90,lons[0]);
    }
    ...
    public void createCountryWithLongitudeUnderMinus180() {
        IllegalArgumentException thrown = assertThrows(IllegalArgumentException.class, () -> new Country(continent2,alpha2Codes[0],alpha3Codes[0],names[0],population[0],capital1,lats[0],-200));
    ...
    public void createCountryWithLongitude180() {
        new Country(continent2,alpha2Codes[0],alpha3Codes[0],names[0],population[0],capital1,lats[0],180);
    }
