...
class GetUnladenCenterMassControllerTest {
    ...
    void getUnladenCenterOfMass() {
        ...
        x = lakeFreighter.getUnladenCenterOfMass().x;
        y = lakeFreighter.getUnladenCenterOfMass().y;
        assertEquals(expX, x, 0.001);
        assertEquals(expY, y, 0.001);
        ...
        x = bulkCarrier.getUnladenCenterOfMass().x;
        y = bulkCarrier.getUnladenCenterOfMass().y;
        assertEquals(expX, x, 0.001);
        assertEquals(expY, y, 0.001);
    }
}