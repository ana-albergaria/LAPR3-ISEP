...
| Step 3: types requested data | ... coordinating the US? | ImportShipsController | IE: It refers to the Controller. There is no reason to assign this responsibility to any existing class in the Domain Model. |
