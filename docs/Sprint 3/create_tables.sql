...
--create table truck(
--	truck_id integer constraint pk_truck PRIMARY KEY NOT NULL
--);
...
--    constraint fk_trucktrip_arrival_warehouse FOREIGN KEY (arrival_location) references warehouse(warehouse_id),
--    constraint fk_trucktrip_depart_warehouse FOREIGN KEY (departure_location) references warehouse(warehouse_id)
--);